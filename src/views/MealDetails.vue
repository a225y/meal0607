<template>
    <div class="max-w-3xl mx-auto bg-emerald-400 p-8">
        <h1 class=" text-5xl font-bold mb-5 mt-3">{{ meal.strMeal }}</h1>
        ...
        <div class=" grid grid-cols-1 sm:grid-cols-3 py-2  bg-gray-800">
            <div>
        ...
        <div class=" grid grid-cols-2 sm:grid-cols-2 bg-yellow-300">
            <div>
                <h2 class=" text-2xl font-semibold mb-3">所需食材：</h2>
                <ul>
            ...
            <div>
                <h2 class=" text-2xl font-semibold mb-3">比例</h2>
                <ul>
                    <template v-for="(el, index) in new Array(20)">
